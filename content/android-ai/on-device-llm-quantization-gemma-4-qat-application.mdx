...
tags:
  ...
  - android-ai
confidence: 1
connections: [android-ai/gemini-nano, android-ai/on-device-llm-quantization-patterns-android, android-ai/android-ai-edge-vs-cloud-decision-framework, harness-engineering/on-device-llm-inference-efficiency-patterns, project-ops/mlops-pipeline-design-ai-model-deployment-monitoring, evaluation/generative-ai-model-evaluation-quantitative-qualitative-meth, data-engineering/llm-fine-tuning-dataset-preparation-strategies, android-ai/on-device-llm-optimization-android-strategies]
status: draft
