...
tags:
  ...
  - android-ai
confidence: 1
connections: [agents/ai-agent-harness-feature-extension-integration-strategy, agents/llm-agent-external-tool-integration-control, harness-engineering/agent-loop-engineering-harness-design-principles, android-ai/gemini-in-android-studio, agents/autonomous-agent-complex-decision-logic-patterns]
status: draft
