...
tags:
  ...
  - prompt-engineering
confidence: 1
connections: [context-engineering/ambient-knowledge-injection, evaluation/llm-output-validation-quality-metrics-design, evaluation/llm-response-quality-automated-evaluation-metrics-design-str, frontend-ai/llm-interactive-ui-frontend-implementation, agents/gpt-5-5-agent-model-evaluation-integration-strategies, evaluation/multi-persona-llm-output-validation-enhancement, harness-engineering/guard-test-pattern]
status: draft
