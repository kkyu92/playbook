...
tags:
  ...
  - harness-engineering
confidence: 1
connections: [prompt-engineering/multi-llm-routing-design-patterns-cost-performance, prompt-engineering/llm-prompt-caching-cost-optimization-patterns, agents/ai-agent-runaway-cost-prevention-control-systems, prompt-engineering/dynamic-prompt-routing-multi-llm-cost-performance, prompt-engineering/llm-scalable-service-architecture-patterns, prompt-engineering/llm-workflow-orchestration-business-logic-patterns, infrastructure/claude-code-cost-optimization-strategies, harness-engineering/gemini-flash-model-upgrade-optimization, prompt-engineering/llm-token-waste-detection-cli, reports/llm-app-performance-cost-automated-reporting, harness-engineering/llm-token-usage-monitoring-cost-efficiency-patterns, harness-engineering/gpt-5-6-ultrafast-mode-agent-output-optimization, prompt-engineering/claude-code-session-context-optimization, harness-engineering/llm-performance-cost-benchmarking-harness-design, prompt-engineering/agent-message-analysis-pipeline-llm-optimization]
status: draft
