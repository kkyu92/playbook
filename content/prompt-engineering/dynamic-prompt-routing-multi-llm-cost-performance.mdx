...
tags:
  ...
  - harness-engineering
confidence: 1
connections: [prompt-engineering/multi-llm-routing-design-patterns-cost-performance, prompt-engineering/llm-scalable-service-architecture-patterns, prompt-engineering/llm-workflow-orchestration-business-logic-patterns, agents/enterprise-agent-management-patterns-llm-orchestration, prompt-engineering/llm-prompt-caching-cost-optimization-patterns, project-ops/large-scale-ai-serving-harness-caching-strategies, agents/llm-agent-control-flow-enhancement-prompt-dependency-reducti, prompt-engineering/llm-api-cost-optimization-harness-design-patterns, agents/glm-5-2-agent-extension-validation-enhancement, prompt-engineering/dynamic-prompt-management-large-scale-llm-workflows, harness-engineering/dynamic-prompt-routing-llm-orchestration-patterns]
status: draft
