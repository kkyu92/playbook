...
tags:
  ...
  - harness-engineering
confidence: 1
connections: [prompt-engineering/multi-llm-routing-design-patterns-cost-performance, harness-engineering/llm-scalable-service-architecture-patterns, harness-engineering/llm-workflow-orchestration-business-logic-patterns, agents/enterprise-agent-management-patterns-llm-orchestration, infrastructure/llm-prompt-caching-cost-optimization-patterns, harness-engineering/large-scale-ai-serving-harness-caching-strategies, agents/llm-agent-control-flow-enhancement-prompt-dependency-reducti, harness-engineering/llm-api-cost-optimization-harness-design-patterns, agents/glm-5-2-agent-extension-validation-enhancement, prompt-engineering/dynamic-prompt-management-large-scale-llm-workflows]
status: draft
