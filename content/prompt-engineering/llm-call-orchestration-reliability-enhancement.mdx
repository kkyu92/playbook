...
tags:
  ...
  - infrastructure
confidence: 1
connections: [project-ops/production-db-ai-agent-guardrails, harness-engineering/agentic-loop-analytical-chain-lite-mode, prompt-engineering/multi-llm-routing-design-patterns-cost-performance, agents/concurrent-fault-tolerant-ai-workflow-design-patterns, agents/external-tool-integration-for-ai-agents, evaluation/llm-ops-pipeline-design-patterns-production-strategy, project-ops/playbook-ai-integrated-logging-system, agents/distributed-ai-harness-design, evaluation/llm-api-retry-logic-design-patterns-resilience, project-ops/ai-service-high-availability-fallback-retry-strategies, evaluation/llm-output-safety-reliability-validation-enhancement, android-ai/on-device-llm-quantization-patterns-android, prompt-engineering/llm-prompt-caching-cost-optimization-patterns, harness-engineering/multi-llm-external-tool-workflow-orchestration-patterns, harness-engineering/agent-human-equivalence-protocol-design]
status: draft
