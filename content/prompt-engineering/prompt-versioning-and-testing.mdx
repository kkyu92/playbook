...
connections: [harness-engineering/drift-detection-methodology, harness-engineering/guard-test-pattern, harness-engineering/hub-worker-compounding-pattern, context-engineering/ambient-knowledge-injection, evaluation/llm-output-validation-quality-metrics-design, prompt-engineering/llm-prompt-optimization-role-definition-constraint-design]
status: draft
