...
connections: [agents/qwen3-6-max-preview-llm-agentic-coding-evaluation, data-engineering/llm-fine-tuning-high-quality-data-preprocessing-refinement, project-ops/generative-ai-mlops-pipeline-design-patterns, harness-engineering/prompt-model-version-management-large-scale-ai, harness-engineering/dynamic-prompt-management-large-scale-llm-workflows, prompt-engineering/rag-prompt-optimization-techniques]
status: draft
