...
tags:
  ...
  - data-engineering
confidence: 1
connections: [data-engineering/rag-embedding-update-pipeline-realtime-strategies, data-engineering/vector-db-embedding-data-optimization-patterns, evaluation/rag-application-evaluation-retrieval-generation-quality, data-engineering/rag-search-performance-evaluation-metrics-design, prompt-engineering/rag-prompt-optimization-retrieval-augmented-generation, evaluation/llm-input-output-data-pipeline-design-patterns, context-engineering/enriching-local-data-with-description-md-sidecars, agents/ai-agent-code-knowledge-graph-integration-efficiency, agents/long-term-memory-management-patterns-for-ai-agents, data-engineering/rag-unstructured-data-preprocessing-optimization, context-engineering/rust-turbovec-jit-semantic-search-embedding-optimization, harness-engineering/rag-pipeline-performance-cost-optimization-patterns, agents/ai-agent-web-search-data-collection-re-ranking, data-engineering/embedding-data-preprocessing-for-rag-efficiency, agents/rag-ai-agent-building-hallucination-retrieval-patterns]
status: draft
