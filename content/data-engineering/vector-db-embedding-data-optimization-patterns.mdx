...
tags:
  ...
  - data-engineering
confidence: 1
connections: [data-engineering/rag-embedding-update-pipeline-realtime-strategies, data-engineering/llm-data-acquisition-high-quality-datasets, data-engineering/llm-fine-tuning-high-quality-data-preprocessing-refinement, context-engineering/ambient-knowledge-injection, evaluation/llm-response-quality-automated-evaluation-metrics-design-str, agents/ouroboros-agent-performance-cost-optimization, data-engineering/rag-search-performance-evaluation-metrics-design, evaluation/rag-application-evaluation-retrieval-generation-quality, frontend-ai/kuku-concepts-playbook-local-markdown-enhancement, agents/autonomous-agent-long-term-memory-management, data-engineering/rag-data-preprocessing-embedding-optimization-strategies, agents/llm-agent-long-term-memory-tool-use-patterns, data-engineering/rag-unstructured-data-preprocessing-optimization, data-engineering/embedding-data-preprocessing-for-rag-efficiency]
status: draft
...
*   [ ] **정기적인 임베딩 모델 및 데이터 재평가**: 임베딩 모델의 성능 저하(Drift)나 데이터 변화에 대응하기 위해 주기적으로 임베딩 품질 및 RAG 시스템 성능을 재평가하는 프로세스를 구축했는가? (`context-engineering/drift-detection-methodology`와 연계).
