...
tags:
  ...
  - data-engineering
confidence: 1
connections: [data-engineering/rag-embedding-update-pipeline-realtime-strategies, data-engineering/llm-data-acquisition-high-quality-datasets, data-engineering/llm-fine-tuning-high-quality-data-preprocessing-refinement, context-engineering/ambient-knowledge-injection, evaluation/llm-output-validation-quality-metrics-design, evaluation/llm-response-quality-automated-evaluation-metrics-design-str, agents/ouroboros-agent-performance-cost-optimization, evaluation/rag-search-performance-evaluation-metrics-design, evaluation/rag-application-evaluation-retrieval-generation-quality]
status: draft
