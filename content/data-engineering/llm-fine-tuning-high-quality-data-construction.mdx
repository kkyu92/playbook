...
tags:
  ...
  - data-engineering
confidence: 1
connections: [data-engineering/llm-data-acquisition-high-quality-datasets, data-engineering/llm-fine-tuning-dataset-preparation-strategies, data-engineering/llm-fine-tuning-high-quality-data-preprocessing-refinement, evaluation/generative-ai-model-evaluation-quantitative-qualitative-meth, evaluation/llm-output-validation-quality-metrics-design, project-ops/production-db-ai-agent-guardrails, prompt-engineering/on-device-llm-inference-efficiency-patterns, prompt-engineering/zero-few-shot-prompt-design-patterns-llm, data-engineering/llm-fine-tuning-high-quality-data-construction-management]
status: draft
