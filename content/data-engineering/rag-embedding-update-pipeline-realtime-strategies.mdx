...
tags:
  ...
  - data-engineering
confidence: 1
connections: [data-engineering/llm-data-acquisition-high-quality-datasets, data-engineering/llm-fine-tuning-high-quality-data-preprocessing-refinement, prompt-engineering/rag-prompt-optimization-retrieval-augmented-generation, data-engineering/vector-db-embedding-data-optimization-patterns, evaluation/rag-search-performance-evaluation-metrics-design, project-ops/realtime-ai-model-deployment-monitoring-patterns, evaluation/llm-input-output-data-pipeline-design-patterns, evaluation/rag-application-evaluation-retrieval-generation-quality, data-engineering/llm-fine-tuning-high-quality-data-construction-management, context-engineering/kuku-concepts-playbook-local-markdown-enhancement, project-ops/ai-model-serving-harness-enterprise-deployment-management, agents/autonomous-agent-long-term-memory-management, context-engineering/mirage-ai-agent-unified-filesystem-integration, data-engineering/rag-data-preprocessing-embedding-optimization-strategies]
status: draft
