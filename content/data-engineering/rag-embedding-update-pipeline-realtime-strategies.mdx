...
tags:
  ...
  - data-engineering
confidence: 1
connections: [data-engineering/llm-data-acquisition-high-quality-datasets, harness-engineering/drift-detection-methodology, evaluation/llm-output-validation-quality-metrics-design, context-engineering/ambient-knowledge-injection, data-engineering/production-db-ai-agent-guardrails, data-engineering/llm-fine-tuning-high-quality-data-preprocessing-refinement, prompt-engineering/rag-prompt-optimization-retrieval-augmented-generation]
status: draft
