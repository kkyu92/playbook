...
tags:
  ...
  - data-engineering
confidence: 1
connections: [data-engineering/rag-data-preprocessing-embedding-optimization-strategies, data-engineering/rag-system-embedding-dataset-optimization-patterns, agents/ai-agent-rag-integration-hallucination-reduction, harness-engineering/llm-api-performance-optimization-patterns, context-engineering/on-device-vector-db-jit-semantic-search, data-engineering/on-device-vector-db-jit-semantic-search-lsm-hnsw, agents/generative-ai-agent-long-term-memory-strategies, agents/autonomous-agent-long-term-memory-implementation, context-engineering/rust-turbovec-jit-semantic-search-embedding-optimization, agents/llm-agent-long-term-memory-management-strategies, harness-engineering/rag-pipeline-performance-cost-optimization-patterns, infrastructure/critical-database-backup-recovery-validation-system, agents/rag-ai-agent-building-hallucination-retrieval-patterns, agents/rag-agent-local-data-source-integration-extension, context-engineering/llm-knowledge-propagation-connection-mechanisms]
status: draft
