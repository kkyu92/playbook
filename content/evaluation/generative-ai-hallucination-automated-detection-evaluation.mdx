...
tags:
  ...
  - evaluation
confidence: 1
connections: [evaluation/llm-response-quality-automated-evaluation-metrics-design-str, evaluation/rag-application-evaluation-retrieval-generation-quality, evaluation/llm-document-integrity-validation-pipeline-enhancement, data-engineering/llm-fine-tuning-high-quality-data-construction-management, project-ops/claude-goal-playbook-worker-automation, evaluation/llm-output-hallucination-detection-pipeline-enhancement, evaluation/claude-code-generation-validation-pipeline-extension, project-ops/playbook-ai-integrated-logging-system, prompt-engineering/llm-prompt-boolean-logic-control-precision-validation, agents/ai-agent-self-correction-design-principles, evaluation/llm-inference-reliability-validation-harness, android-ai/ml-kit, agents/llm-agent-memory-diagnostic-architecture-brain-ai, harness-engineering/llm-output-validation-dark-factory-evolution, agents/ai-agent-code-refactoring-migration-workflow-design]
status: draft
