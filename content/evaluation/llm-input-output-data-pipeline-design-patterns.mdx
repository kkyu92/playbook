...
tags:
  ...
  - harness-engineering
confidence: 1
connections: [data-engineering/rag-embedding-update-pipeline-realtime-strategies, agents/enterprise-agent-management-patterns-llm-orchestration, agents/code-based-agent-task-patterns-harness-design, evaluation/llm-output-hallucination-detection-pipeline-enhancement, project-ops/playbook-ai-integrated-logging-system, agents/mirage-ai-agent-unified-filesystem-integration, data-engineering/rag-data-preprocessing-embedding-optimization-strategies, context-engineering/enriching-local-data-with-description-md-sidecars, evaluation/llm-workload-management-mlops-pipeline-design-patterns, prompt-engineering/multimodal-harness-design-complex-llm-workflows, prompt-engineering/dynamic-prompt-management-large-scale-llm-workflows, android-ai/mediapipe, context-engineering/llm-agent-context-sensitive-data-leakage-prevention, data-engineering/llm-dataset-construction-versioning-strategies]
status: draft
