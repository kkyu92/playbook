...
tags:
  ...
  - evaluation
confidence: 1
connections: [evaluation/generative-ai-model-evaluation-quantitative-qualitative-meth, data-engineering/llm-fine-tuning-high-quality-data-preprocessing-refinement, prompt-engineering/llm-prompt-optimization-role-definition-constraint-design, prompt-engineering/prompt-versioning-and-testing, harness-engineering/drift-detection-methodology, project-ops/generative-ai-mlops-pipeline-design-patterns, evaluation/multi-persona-llm-output-validation-enhancement, prompt-engineering/multi-turn-conversation-prompt-design-patterns, evaluation/llm-ux-evaluation-metrics-design-measurement, prompt-engineering/rag-prompt-optimization-retrieval-augmented-generation, data-engineering/vector-db-embedding-data-optimization-patterns, evaluation/rag-search-performance-evaluation-metrics-design, reports/ai-project-kpi-dashboard-building-strategy, evaluation/rag-application-evaluation-retrieval-generation-quality, evaluation/prediction-model-calibration-inversion-detection]
status: draft
