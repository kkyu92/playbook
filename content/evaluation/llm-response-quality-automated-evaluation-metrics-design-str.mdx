...
tags:
  ...
  - evaluation
confidence: 1
connections: [data-engineering/rag-search-performance-evaluation-metrics-design, reports/ai-project-kpi-dashboard-building-strategy, evaluation/rag-application-evaluation-retrieval-generation-quality, evaluation/prediction-model-calibration-inversion-detection, frontend-ai/nextjs-security-patching-defense-logic-reinforcement, evaluation/llm-document-integrity-validation-pipeline-enhancement, data-engineering/llm-fine-tuning-high-quality-data-construction-management, evaluation/llm-output-hallucination-detection-pipeline-enhancement, evaluation/llm-output-validation-supervisee-fatigue-mitigation, reports/automated-ai-performance-reports, harness-engineering/llm-application-cicd-workflow-design-patterns, harness-engineering/llm-continuous-performance-validation, prompt-engineering/llm-output-quality-agent-guidelines, reports/llm-performance-tracking-automated-reporting, evaluation/llm-output-content-quality-validation-extension]
status: draft
