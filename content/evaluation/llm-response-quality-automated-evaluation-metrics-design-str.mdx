...
tags:
  ...
  - evaluation
confidence: 1
connections: [prompt-engineering/rag-prompt-optimization-retrieval-augmented-generation, data-engineering/vector-db-embedding-data-optimization-patterns, data-engineering/rag-search-performance-evaluation-metrics-design, reports/ai-project-kpi-dashboard-building-strategy, evaluation/rag-application-evaluation-retrieval-generation-quality, evaluation/prediction-model-calibration-inversion-detection, frontend-ai/nextjs-security-patching-defense-logic-reinforcement, evaluation/llm-document-integrity-validation-pipeline-enhancement, data-engineering/llm-fine-tuning-high-quality-data-construction-management, evaluation/generative-ai-hallucination-automated-detection-evaluation, evaluation/llm-output-hallucination-detection-pipeline-enhancement, evaluation/llm-output-validation-supervisee-fatigue-mitigation, reports/automated-ai-performance-reports, harness-engineering/llm-application-cicd-workflow-design-patterns, harness-engineering/llm-continuous-performance-validation]
status: draft
