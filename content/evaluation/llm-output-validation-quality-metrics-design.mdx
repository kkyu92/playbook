...
tags:
  ...
  - evaluation
confidence: 1
connections: [harness-engineering/drift-detection-methodology, harness-engineering/guard-test-pattern, harness-engineering/question-own-defaults, journal/playbook-journal-003-drift-silent-bugs, prompt-engineering/prompt-versioning-and-testing, journal/playbook-journal-005-moneyballscore-playbook-e2e, context-engineering/ambient-knowledge-injection, prompt-engineering/llm-prompt-optimization-role-definition-constraint-design]
status: draft
