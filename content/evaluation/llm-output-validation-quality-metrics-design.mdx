...
tags:
  ...
  - evaluation
confidence: 1
connections: [data-engineering/rag-embedding-update-pipeline-realtime-strategies, agents/multi-llm-agent-workload-partitioning-patterns, evaluation/llm-ux-evaluation-metrics-design-measurement, harness-engineering/claude-api-openclaw-keyword-guard-behavior-drift-detection, prompt-engineering/rag-prompt-optimization-retrieval-augmented-generation, project-ops/claude-code-cost-optimization-strategies, data-engineering/vector-db-embedding-data-optimization-patterns, evaluation/rag-search-performance-evaluation-metrics-design, prompt-engineering/multi-turn-prompt-design-complex-intent-clarification, reports/ai-project-kpi-dashboard-building-strategy, harness-engineering/deepseek-v4-pro-llm-backend-integration, harness-engineering/llm-input-output-data-pipeline-design-patterns, evaluation/rag-application-evaluation-retrieval-generation-quality, harness-engineering/claude-code-harness-skillset-reinforcement-agent-playbook, infrastructure/llm-call-orchestration-reliability-enhancement]
status: draft
