...
tags:
  ...
  - harness-engineering
confidence: 1
connections: [context-engineering/ambient-knowledge-injection, agents/enterprise-agent-management-patterns-llm-orchestration, context-engineering/claude-code-session-web-mobile-monitoring-implementation, infrastructure/sentry-pii-scrubbing-beforesend, infrastructure/claude-code-ctx-plugin-context-persistence, prompt-engineering/on-device-llm-inference-efficiency-patterns, context-engineering/claude-code-harness-large-codebase-architecture-patterns, agents/ai-agent-persistent-memory-automated-context-management, infrastructure/claude-cli-persistent-multi-session-web-terminal]
status: draft
