...
tags:
  ...
  - context-engineering
confidence: 1
connections: [context-engineering/ambient-knowledge-injection, context-engineering/claude-code-ctx-plugin-context-persistence, agents/enterprise-agent-management-patterns-llm-orchestration, harness-engineering/code-based-agent-task-patterns-harness-design, agents/multi-agent-task-collaboration-coordination-strategies, agents/autonomous-agent-long-term-memory-management]
status: draft
