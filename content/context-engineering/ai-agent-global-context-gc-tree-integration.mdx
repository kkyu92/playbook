...
tags:
  ...
  - context-engineering
confidence: 1
connections: [context-engineering/ai-agent-context-window-optimization-session-longevity, context-engineering/ambient-knowledge-injection, context-engineering/claude-code-ctx-plugin-context-persistence, agents/llm-agent-goal-achievement-planning-patterns, harness-engineering/enterprise-agent-management-patterns-llm-orchestration, harness-engineering/code-based-agent-task-patterns-harness-design, agents/multi-llm-agent-workload-partitioning-patterns, agents/multi-agent-task-collaboration-coordination-strategies]
status: draft
