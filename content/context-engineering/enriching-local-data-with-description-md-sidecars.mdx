...
tags:
  ...
  - rag-optimization
confidence: 1
connections: [context-engineering/ambient-knowledge-injection, frontend-ai/kuku-concepts-playbook-local-markdown-enhancement, agents/mirage-ai-agent-unified-filesystem-integration, data-engineering/rag-data-preprocessing-embedding-optimization-strategies, agents/agentic-self-documentation-dual-perspective-knowledge-accumulation, evaluation/llm-input-output-data-pipeline-design-patterns, prompt-engineering/rag-prompt-optimization-retrieval-augmented-generation]
status: draft
