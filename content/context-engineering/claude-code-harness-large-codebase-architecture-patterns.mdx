...
tags:
  ...
  - harness-engineering
confidence: 1
connections: [context-engineering/agentic-coding-claude-harness-playbook-strategy, project-ops/claude-code-harness-skillset-reinforcement-agent-playbook, context-engineering/claude-code-session-context-persistence-ctx-plugin, agents/code-based-agent-task-patterns-harness-design, infrastructure/claude-code-ctx-plugin-context-persistence, agents/ruflo-multi-agent-orchestration-claude-code-playbooks, infrastructure/claude-code-harness-multi-llm-strategy-dependency-mitigation, context-engineering/flue-framework-integration-claude-code-harness-reconfigurati, agents/ai-agent-code-knowledge-graph-integration-efficiency, agents/agent-codebase-exploration-visualization-tool, agents/ai-agent-harness-verticalization-strategy, project-ops/streamlined-ai-agent-harness-design, harness-engineering/claude-code-workflow-iteration-optimization, agents/ai-agent-code-refactoring-migration-workflow-design]
status: draft
