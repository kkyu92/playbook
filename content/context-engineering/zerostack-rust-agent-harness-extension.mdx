...
tags:
  ...
  - harness-engineering
confidence: 1
connections: [agents/external-tool-integration-for-ai-agents, context-engineering/agentic-coding-claude-harness-playbook-strategy, agents/code-based-agent-task-patterns-harness-design, agents/llm-agent-tool-use-design-patterns, project-ops/production-db-ai-agent-guardrails, agents/llm-agent-control-flow-enhancement-prompt-dependency-reducti]
status: draft
