...
tags:
  ...
  - harness-engineering
confidence: 1
connections: [agents/ai-agent-remote-management-ux-persistent-web-terminals, agents/collaboration-conflict-resolution-multi-agent-systems, agents/multi-llm-agent-workload-partitioning-patterns, agents/ai-agent-context-window-optimization-session-longevity, context-engineering/claude-code-ctx-plugin-context-persistence, frontend-ai/ai-inference-visualization-design-patterns]
status: draft
