...
tags:
  ...
  - harness-engineering
confidence: 1
connections: [infrastructure/claude-code-ctx-plugin-context-persistence, context-engineering/claude-code-session-web-mobile-monitoring-implementation, infrastructure/claude-api-openclaw-keyword-guard-behavior-drift-detection]
status: draft
