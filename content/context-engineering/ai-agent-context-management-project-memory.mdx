...
tags:
  ...
  - context-engineering
confidence: 1
connections: [agents/ai-agent-persistent-memory-automated-context-management, context-engineering/ai-agent-long-term-memory-system-integration, agents/ai-agent-shared-brain-system-context-persistence-collaborati, agents/autonomous-agent-long-term-memory-management, context-engineering/claude-code-agent-persistent-memory-ctx-integration, context-engineering/ambient-knowledge-injection, data-engineering/bigset-structured-data-collection-knowledge-hubs, agents/autonomous-agent-long-term-memory-implementation]
status: draft
