...
tags:
  ...
  - context-engineering
confidence: 1
connections: [context-engineering/ai-agent-long-term-memory-system-integration, agents/ai-agent-shared-brain-system-context-persistence-collaborati, agents/autonomous-agent-long-term-memory-management, context-engineering/claude-code-agent-persistent-memory-ctx-integration, data-engineering/bigset-structured-data-collection-knowledge-hubs, agents/autonomous-agent-long-term-memory-implementation, context-engineering/ai-agent-codebase-wiki-contextual-enhancement, context-engineering/kimi-k3-context-engineering-knowledge-processing, context-engineering/llm-data-bias-context-engineering-knowledge-graph-enhancemen, agents/munder-difflin-agent-harness-context-management, agents/prime-agent-rlm-continual-harness-playbook-advancement, harness-engineering/ai-agent-local-memory-module-session-context, context-engineering/file-based-agent-memory-management, agents/rag-autonomous-agent-decision-logic-design-patterns, harness-engineering/agent-harness-context-management-optimization]
status: draft
