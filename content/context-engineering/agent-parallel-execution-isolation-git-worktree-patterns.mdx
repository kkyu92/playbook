...
tags:
  ...
  - harness-engineering
confidence: 1
connections: [context-engineering/hub-worker-compounding-pattern, agents/multi-llm-agent-workload-partitioning-patterns, agents/concurrent-fault-tolerant-ai-workflow-design-patterns, prompt-engineering/llm-workflow-orchestration-business-logic-patterns, evaluation/llm-output-validation-quality-metrics-design, agents/distributed-ai-harness-design, agents/llm-agent-workflow-management-validation]
status: draft
