...
tags:
  ...
  - context-engineering
confidence: 1
connections: [evaluation/llm-document-integrity-validation-pipeline-enhancement, prompt-engineering/zero-few-shot-prompt-design-patterns-llm, infrastructure/bifrost-high-speed-enterprise-ai-gateway-integration, context-engineering/kuku-concepts-playbook-local-markdown-enhancement, harness-engineering/llm-scalable-service-architecture-patterns, harness-engineering/claude-code-agent-view-worker-management-integration, agents/claude-goal-playbook-worker-automation, agents/multi-tool-ai-agent-design-patterns-orchestration, agents/ruflo-multi-agent-orchestration-claude-code-playbooks, harness-engineering/superagent-harness-architecture-long-running-task-orchestrat, agents/external-tool-integration-for-ai-agents, agents/ai-collaboration-5-principles-playbook-agent-workflow-optimi, agents/autonomous-agent-long-term-memory-management, harness-engineering/llm-agent-persistent-goal-management-long-term-tasks, context-engineering/mirage-ai-agent-unified-filesystem-integration]
status: draft
