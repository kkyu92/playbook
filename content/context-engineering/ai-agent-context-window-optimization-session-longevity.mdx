...
tags:
  ...
  - context-engineering
confidence: 1
connections: [agents/ai-collaboration-5-principles-playbook-agent-workflow-optimi, agents/autonomous-agent-long-term-memory-management, harness-engineering/llm-agent-persistent-goal-management-long-term-tasks, context-engineering/mirage-ai-agent-unified-filesystem-integration, agents/inference-chain-design-complex-ai-agents, agents/ai-agent-persistent-memory-automated-context-management, context-engineering/ai-agent-code-knowledge-graph-integration-efficiency, harness-engineering/claude-5-fable-llm-worker-harness-compounding-automation, agents/long-term-memory-management-patterns-for-ai-agents, context-engineering/ai-agent-long-term-memory-system-integration, harness-engineering/claude-code-token-optimization-code-graph-integration, context-engineering/claude-code-agent-persistent-memory-ctx-integration, harness-engineering/vhk-ai-coding-harness-design-principles, harness-engineering/claude-code-harness-cost-optimization-via-pxpipe, harness-engineering/claude-code-harness-session-cache-leakage-prevention]
status: draft
