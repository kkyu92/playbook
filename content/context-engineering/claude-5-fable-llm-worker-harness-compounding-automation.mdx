...
tags:
  ...
  - harness-engineering
confidence: 1
connections: [project-ops/claude-goal-playbook-worker-automation, context-engineering/hub-worker-compounding-pattern, agents/llm-agent-persistent-goal-management-long-term-tasks, evaluation/llm-output-validation-quality-metrics-design, agents/superagent-harness-architecture-long-running-task-orchestrat, agents/ai-agent-context-window-optimization-session-longevity, prompt-engineering/llm-workflow-orchestration-business-logic-patterns, context-engineering/claude-5-context-engineering-prompt-optimization]
status: draft
