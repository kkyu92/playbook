...
tags:
  ...
  - harness-engineering
confidence: 1
connections: [agents/claude-goal-playbook-worker-automation, project-ops/claude-code-harness-skillset-reinforcement-agent-playbook, context-engineering/hub-worker-compounding-pattern, context-engineering/claude-code-ctx-plugin-context-persistence, harness-engineering/zero-touch-develop-cycle-session-management, agents/lao-workflow-llm-agent-design-enhancement, context-engineering/claude-code-harness-large-codebase-architecture-patterns, evaluation/claude-code-generation-validation-pipeline-extension, context-engineering/zerostack-rust-agent-harness-extension, agents/qwen3-7-max-agent-model-evaluation-integration, project-ops/claude-code-harness-cost-optimization-reassessment, context-engineering/flue-framework-integration-claude-code-harness-reconfigurati, infrastructure/claude-cli-persistent-multi-session-web-terminal]
status: draft
