...
tags:
  ...
  - harness-engineering
confidence: 1
connections: [context-engineering/agentic-coding-claude-harness-playbook-strategy, context-engineering/claude-code-harness-large-codebase-architecture-patterns, agents/claude-goal-playbook-worker-automation, context-engineering/hub-worker-compounding-pattern, prompt-engineering/llm-workflow-orchestration-business-logic-patterns, agents/ai-agent-remote-management-ux-persistent-web-terminals, agents/code-based-agent-task-patterns-harness-design]
status: draft
