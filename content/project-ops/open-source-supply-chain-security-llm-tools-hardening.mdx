...
tags:
  ...
  - infrastructure
confidence: 1
connections: [infrastructure/npm-pnpm-supply-chain-security-enhancement, infrastructure/vercel-breach-third-party-ai-oauth-supply-chain-security, infrastructure/github-token-anti-recursion-ghat-pat-workflow-trigger, project-ops/claude-api-key-security-audit-usage-pattern-validation, evaluation/llm-api-dependency-risk-mitigation-strategy, journal/playbook-journal-037-pnpm-lock-yaml-ci-frozen-lockfile, infrastructure/claude-interaction-security-guidelines-endpoint-protection, infrastructure/github-actions-oidc-audience-restriction-security, project-ops/github-actions-security-auditing-hardening, project-ops/ci-cd-log-xss-vulnerability-hardening]
status: draft
