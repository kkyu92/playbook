...
tags:
  ...
  - project-ops
confidence: 1
connections: [data-engineering/llm-fine-tuning-high-quality-data-preprocessing-refinement, context-engineering/drift-detection-methodology, prompt-engineering/prompt-versioning-and-testing, project-ops/ai-project-planning-roadmap-initial-strategy, evaluation/llm-response-quality-automated-evaluation-metrics-design-str, project-ops/mlops-pipeline-design-ai-model-deployment-monitoring, evaluation/llm-ops-pipeline-design-patterns-production-strategy, project-ops/playbook-ai-integrated-logging-system, agents/multimodal-ai-model-serving-architecture-patterns, evaluation/llm-workload-management-mlops-pipeline-design-patterns]
status: draft
