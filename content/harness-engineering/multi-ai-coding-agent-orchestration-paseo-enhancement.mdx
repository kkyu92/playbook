...
tags:
  ...
  - harness-engineering
confidence: 1
connections: [agents/multi-agent-collaboration-system-design-patterns, agents/llm-multi-agent-system-design-orchestration-patterns, harness-engineering/claude-code-dynamic-workflows-harness-integration, harness-engineering/llm-workflow-orchestration-patterns-complex-ai-applications, agents/ai-agent-parallel-task-orchestration-and-auto-merge, context-engineering/agentic-multi-agent-chain-pool-ecosystem-specialization, agents/llm-agent-dynamic-tool-selection-optimization]
status: draft
