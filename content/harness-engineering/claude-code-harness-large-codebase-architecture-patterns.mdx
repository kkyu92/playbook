...
tags:
  ...
  - harness-engineering
confidence: 1
connections: [harness-engineering/agentic-coding-claude-harness-playbook-strategy, harness-engineering/claude-code-harness-skillset-reinforcement-agent-playbook, harness-engineering/claude-code-session-context-persistence-ctx-plugin, harness-engineering/code-based-agent-task-patterns-harness-design, agents/llm-agent-tool-use-design-patterns, context-engineering/claude-code-ctx-plugin-context-persistence, agents/ruflo-multi-agent-orchestration-claude-code-playbooks]
status: draft
