...
tags:
  ...
  - harness-engineering
confidence: 1
connections: [harness-engineering/code-based-agent-task-patterns-harness-design, context-engineering/claude-code-ctx-plugin-context-persistence, harness-engineering/agentic-loop-analytical-chain-lite-mode, evaluation/rag-application-evaluation-retrieval-generation-quality, infrastructure/nextjs-security-patching-defense-logic-reinforcement, agents/llm-agent-control-flow-enhancement-prompt-dependency-reducti, agents/ruflo-multi-agent-orchestration-claude-code-playbooks, harness-engineering/agentic-coding-claude-harness-playbook-strategy, harness-engineering/claude-code-harness-large-codebase-architecture-patterns, agents/llm-judgment-code-verification-separation-architecture]
status: draft
