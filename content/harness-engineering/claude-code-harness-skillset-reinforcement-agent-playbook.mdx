...
tags:
  ...
  - harness-engineering
confidence: 1
connections: [harness-engineering/code-based-agent-task-patterns-harness-design, agents/llm-agent-goal-achievement-planning-patterns, context-engineering/claude-code-ctx-plugin-context-persistence, evaluation/llm-output-validation-quality-metrics-design, harness-engineering/agentic-loop-analytical-chain-lite-mode, agents/multi-llm-agent-workload-partitioning-patterns, evaluation/rag-application-evaluation-retrieval-generation-quality, infrastructure/nextjs-security-patching-defense-logic-reinforcement, harness-engineering/llm-agent-control-flow-enhancement-prompt-dependency-reducti, agents/ruflo-multi-agent-orchestration-claude-code-playbooks, harness-engineering/agentic-coding-claude-harness-playbook-strategy, harness-engineering/claude-code-harness-large-codebase-architecture-patterns]
status: draft
