...
tags:
  ...
  - harness-engineering
confidence: 1
connections: [prompt-engineering/multi-llm-routing-design-patterns-cost-performance, infrastructure/llm-prompt-caching-cost-optimization-patterns, project-ops/ai-agent-runaway-cost-prevention-control-systems, prompt-engineering/dynamic-prompt-routing-multi-llm-cost-performance, harness-engineering/llm-scalable-service-architecture-patterns, harness-engineering/llm-workflow-orchestration-business-logic-patterns, project-ops/claude-code-cost-optimization-strategies]
status: draft
