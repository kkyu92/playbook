...
tags:
  ...
  - harness-engineering
confidence: 1
connections: [agents/claude-goal-playbook-worker-automation, harness-engineering/hub-worker-compounding-pattern, harness-engineering/zero-touch-develop-cycle-session-management, harness-engineering/claude-code-harness-large-codebase-architecture-patterns, evaluation/claude-code-generation-validation-pipeline-extension, harness-engineering/zerostack-rust-agent-harness-extension, agents/qwen3-7-max-agent-model-evaluation-integration, project-ops/claude-code-harness-cost-optimization-reassessment, harness-engineering/flue-framework-integration-claude-code-harness-reconfigurati, harness-engineering/claude-cli-persistent-multi-session-web-terminal, harness-engineering/llm-agent-full-automation-development-pipeline-expansion, harness-engineering/flutter-flame-game-launch-harness-claude-code-optimization, context-engineering/claude-code-agent-persistent-memory-ctx-integration, harness-engineering/glm52-zcode-multi-agent-harness-playbook-enhancement, prompt-engineering/claude-fable-5-safeguards-prompt-engineering-recalibration]
status: draft
