...
tags:
  ...
  - harness-engineering
confidence: 1
connections: [harness-engineering/guard-test-pattern, agents/llm-agent-tool-use-design-patterns, evaluation/llm-output-validation-quality-metrics-design, harness-engineering/concurrent-fault-tolerant-ai-workflow-design-patterns, agents/ai-agent-safety-constraint-control-design-patterns, agents/llm-agent-dynamic-tool-selection-optimization, agents/llm-agent-long-term-memory-tool-use-patterns, agents/multimodal-ai-agent-tool-usage-design, agents/advanced-ai-agent-tool-use-patterns, project-ops/ai-agent-runaway-cost-prevention-control-systems, harness-engineering/agent-harness-code-execution-feedback-principles, agents/opentag-slack-playbook-worker-automation-poc]
status: draft
