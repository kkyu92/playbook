...
tags:
  ...
  - agents
confidence: 1
connections: [harness-engineering/claude-code-harness-skillset-reinforcement-agent-playbook, harness-engineering/llm-agent-control-flow-enhancement-prompt-dependency-reducti, project-ops/ai-project-scope-management-complexity-change, evaluation/llm-document-integrity-validation-pipeline-enhancement, harness-engineering/claude-code-agent-view-worker-management-integration, agents/claude-goal-playbook-worker-automation, agents/multi-tool-ai-agent-design-patterns-orchestration, agents/multi-agent-task-collaboration-coordination-strategies, agents/ruflo-multi-agent-orchestration-claude-code-playbooks, harness-engineering/llm-workflow-orchestration-business-logic-patterns, harness-engineering/superagent-harness-architecture-long-running-task-orchestrat, agents/external-tool-integration-for-ai-agents, agents/ai-agent-superpowers-guardrails-intent-alignment, agents/ai-collaboration-5-principles-playbook-agent-workflow-optimi, agents/autonomous-agent-long-term-memory-management]
status: draft
