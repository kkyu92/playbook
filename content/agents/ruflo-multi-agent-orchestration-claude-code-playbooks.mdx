...
tags:
  ...
  - agents
confidence: 1
connections: [agents/multi-agent-task-collaboration-coordination-strategies, agents/multi-llm-agent-workload-partitioning-patterns, project-ops/claude-code-harness-skillset-reinforcement-agent-playbook, agents/enterprise-agent-management-patterns-llm-orchestration, infrastructure/claude-code-ctx-plugin-context-persistence, context-engineering/claude-code-harness-large-codebase-architecture-patterns, agents/ai-agent-parallel-task-orchestration-and-auto-merge]
status: draft
