...
tags:
  ...
  - agents
confidence: 1
connections: [agents/multi-agent-task-collaboration-coordination-strategies, agents/multi-llm-agent-workload-partitioning-patterns, agents/llm-agent-goal-achievement-planning-patterns, project-ops/claude-code-harness-skillset-reinforcement-agent-playbook, agents/enterprise-agent-management-patterns-llm-orchestration, agents/ai-agent-context-window-optimization-session-longevity, context-engineering/claude-code-ctx-plugin-context-persistence, context-engineering/claude-code-harness-large-codebase-architecture-patterns]
status: draft
