...
tags:
  ...
  - agents
confidence: 1
connections: [agents/qwen3-6-max-preview-llm-agentic-coding-evaluation, harness-engineering/gstack-framework-ai-agent-collaboration-architecture, prompt-engineering/llm-prompt-optimization-role-definition-constraint-design, agents/google-agents-cli-agent-development-acceleration, evaluation/multi-persona-llm-output-validation-enhancement, prompt-engineering/multi-turn-conversation-prompt-design-patterns, infrastructure/gomodel-llm-gateway-introduction-strategy, agents/ouroboros-agent-performance-cost-optimization, evaluation/rag-search-performance-evaluation-metrics-design, evaluation/llm-hallucination-analysis-output-validation-pipeline]
status: draft
