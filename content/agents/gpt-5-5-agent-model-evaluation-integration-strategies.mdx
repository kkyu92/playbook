...
tags:
  ...
  - agents
confidence: 1
connections: [agents/qwen3-6-max-preview-llm-agentic-coding-evaluation, agents/gstack-framework-ai-agent-collaboration-architecture, prompt-engineering/llm-prompt-optimization-role-definition-constraint-design, agents/google-agents-cli-agent-development-acceleration, agents/multi-persona-llm-output-validation-enhancement, prompt-engineering/multi-turn-conversation-prompt-design-patterns, android-ai/gomodel-llm-gateway-introduction-strategy, agents/ouroboros-agent-performance-cost-optimization, data-engineering/rag-search-performance-evaluation-metrics-design]
status: draft
