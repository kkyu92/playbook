...
tags:
  ...
  - agents
confidence: 1
connections: [agents/llm-agent-goal-achievement-planning-patterns, agents/autonomous-agent-dynamic-planning-goal-strategies, agents/autonomous-ai-agent-task-planning-execution-patterns, agents/llm-autonomous-agent-self-reflection-tool-use-patterns, agents/llm-agent-persistent-goal-management-long-term-tasks, agents/multi-agent-collaboration-complex-problem-solving, agents/llm-agent-task-decomposition-delegation-patterns, agents/autonomous-agent-behavioral-planning-reasoning-system-design]
status: draft
