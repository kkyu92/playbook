...
tags:
  ...
  - harness-engineering
confidence: 1
connections: [agents/multi-agent-collaboration-complex-problem-solving, agents/multi-agent-task-collaboration-coordination-strategies, agents/llm-agent-goal-achievement-planning-patterns, agents/enterprise-agent-management-patterns-llm-orchestration, agents/ai-agent-context-window-optimization-session-longevity, agents/llm-agent-persistent-goal-management-long-term-tasks, agents/distributed-ai-harness-design, context-engineering/claude-5-fable-llm-worker-harness-compounding-automation, agents/multi-stage-agent-task-scheduling-monitoring, agents/glm-5-2-agent-extension-validation-enhancement, evaluation/llm-output-system-boundary-sanitization-pipeline]
status: draft
