...
tags:
  ...
  - agents
confidence: 1
connections: [agents/llm-agent-goal-achievement-planning-patterns, agents/llm-agent-tool-use-design-patterns, agents/ai-agent-context-window-optimization-session-longevity, agents/ai-agent-global-context-gc-tree-integration, data-engineering/rag-embedding-update-pipeline-realtime-strategies, data-engineering/vector-db-embedding-data-optimization-patterns, prompt-engineering/rag-prompt-optimization-retrieval-augmented-generation, agents/long-term-agent-behavior-anomaly-detection-response, agents/llm-agent-persistent-goal-management-long-term-tasks, agents/qwen3-7-max-agent-model-evaluation-integration, agents/inference-chain-design-complex-ai-agents, agents/ai-agent-persistent-memory-automated-context-management, agents/llm-agent-long-term-memory-tool-use-patterns, agents/glm-5-2-agent-extension-validation-enhancement, agents/long-term-memory-management-patterns-for-ai-agents]
status: draft
