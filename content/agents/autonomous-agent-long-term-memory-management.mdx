...
tags:
  ...
  - agents
confidence: 1
connections: [agents/llm-agent-tool-use-design-patterns, agents/long-term-agent-behavior-anomaly-detection-response, agents/llm-agent-persistent-goal-management-long-term-tasks, agents/qwen3-7-max-agent-model-evaluation-integration, agents/inference-chain-design-complex-ai-agents, agents/ai-agent-persistent-memory-automated-context-management, agents/llm-agent-long-term-memory-tool-use-patterns, agents/glm-5-2-agent-extension-validation-enhancement, agents/long-term-memory-management-patterns-for-ai-agents, agents/agentic-context-compaction-trigger-heuristics, context-engineering/agentic-oos-memory-drift-count-smoke-baseline, agents/llm-agent-memory-diagnostic-architecture-brain-ai, context-engineering/ai-agent-context-management-project-memory, agents/multi-hop-reasoning-agent-design-patterns, agents/autonomous-agent-long-term-memory-implementation]
status: draft
