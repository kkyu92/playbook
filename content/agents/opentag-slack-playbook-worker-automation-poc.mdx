...
tags:
  ...
  - agents
confidence: 1
connections: [agents/external-tool-integration-for-ai-agents, agents/llm-agent-tool-use-design-patterns, harness-engineering/ai-agent-prompt-harness-standardization-oh-my-harness, harness-engineering/llm-agent-tool-call-reliability-forge-guardrails]
status: draft
