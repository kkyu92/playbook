...
tags:
  ...
  - agents
confidence: 1
connections: [agents/llm-agent-goal-achievement-planning-patterns, agents/llm-agent-tool-use-design-patterns, agents/multi-agent-collaboration-complex-problem-solving, agents/inference-chain-design-complex-ai-agents, agents/llm-agent-persistent-goal-management-long-term-tasks, prompt-engineering/llm-workflow-orchestration-business-logic-patterns, agents/llm-agent-dynamic-tool-selection-optimization, agents/autonomous-ai-agent-decision-logic-implementation-patterns, agents/glm-5-2-agent-extension-validation-enhancement, agents/multi-agent-collaboration-complex-task-patterns, agents/llm-agent-planning-reflection-autonomous-problem-solving, agents/generative-ai-agent-autonomous-problem-solving-patterns]
status: draft
