...
tags:
  ...
  - agents
confidence: 1
connections: [agents/llm-agent-goal-achievement-planning-patterns, agents/llm-agent-tool-use-design-patterns, agents/multi-agent-collaboration-complex-problem-solving, agents/inference-chain-design-complex-ai-agents, harness-engineering/llm-agent-persistent-goal-management-long-term-tasks, harness-engineering/llm-workflow-orchestration-business-logic-patterns, agents/llm-agent-dynamic-tool-selection-optimization, agents/autonomous-ai-agent-decision-logic-implementation-patterns, agents/ai-agent-self-correction-design-principles, agents/glm-5-2-agent-extension-validation-enhancement, agents/multi-agent-collaboration-complex-task-patterns, agents/ai-agent-rag-integration-hallucination-reduction, agents/autonomous-agent-multi-stage-decision-making-patterns, agents/autonomous-agent-dynamic-planning-goal-strategies, harness-engineering/agent-loop-patterns-autonomous-task-completion]
status: draft
