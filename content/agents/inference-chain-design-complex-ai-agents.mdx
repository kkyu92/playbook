...
tags:
  ...
  - agents
confidence: 1
connections: [agents/llm-agent-goal-achievement-planning-patterns, agents/llm-agent-tool-use-design-patterns, agents/multi-agent-collaboration-complex-problem-solving, agents/autonomous-agent-long-term-memory-management, harness-engineering/llm-agent-control-flow-enhancement-prompt-dependency-reducti, context-engineering/ai-agent-context-window-optimization-session-longevity, prompt-engineering/lao-workflow-llm-agent-design-enhancement, agents/llm-agent-dynamic-tool-selection-optimization, agents/llm-agent-autonomy-complex-problem-solving, agents/autonomous-ai-agent-decision-logic-implementation-patterns, prompt-engineering/cot-prompting-complex-reasoning-patterns, agents/autonomous-agent-reasoning-debugging-optimization]
status: draft
