...
tags:
  ...
  - agents
confidence: 1
connections: [agents/llm-agent-goal-achievement-planning-patterns, agents/llm-agent-tool-use-design-patterns, agents/multi-agent-collaboration-complex-problem-solving, agents/autonomous-agent-long-term-memory-management, agents/llm-agent-control-flow-enhancement-prompt-dependency-reducti, agents/ai-agent-context-window-optimization-session-longevity, agents/lao-workflow-llm-agent-design-enhancement, agents/llm-agent-dynamic-tool-selection-optimization, agents/llm-agent-autonomy-complex-problem-solving, agents/autonomous-ai-agent-decision-logic-implementation-patterns]
status: draft
