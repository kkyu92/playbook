...
tags:
  ...
  - agents
confidence: 1
connections: [agents/concurrent-fault-tolerant-ai-workflow-design-patterns, agents/external-tool-integration-for-ai-agents, agents/multimodal-ai-agent-effective-tool-integration, agents/multimodal-ai-orchestration-design-patterns, agents/llm-agent-long-term-memory-tool-use-patterns, agents/multimodal-ai-agent-tool-usage-design, agents/advanced-ai-agent-tool-use-patterns, android-ai/android-background-ai-workflow-workmanager, android-ai/firebase-ai-logic-android-client-sdk, android-ai/mediapipe, harness-engineering/multi-llm-external-api-harness-integration-patterns, harness-engineering/multimodal-ai-workflow-harness-integration-patterns, agents/llm-agent-external-tool-integration-control, agents/agent-plugin-architecture-design-modularity, agents/autonomous-agent-reliable-tool-use-patterns]
status: draft
