...
tags:
  ...
  - agents
confidence: 1
connections: [agents/llm-agent-goal-achievement-planning-patterns, agents/multi-llm-agent-workload-partitioning-patterns, agents/claude-goal-playbook-worker-automation, context-engineering/agentic-cycle-state-json-carry-over-design, context-engineering/ai-agent-context-window-optimization-session-longevity, data-engineering/production-db-ai-agent-guardrails, agents/multi-agent-task-collaboration-coordination-strategies, agents/multi-agent-collaboration-complex-problem-solving, harness-engineering/concurrent-fault-tolerant-ai-workflow-design-patterns, agents/external-tool-integration-for-ai-agents, agents/multi-agent-collaboration-design-patterns, agents/multimodal-ai-agent-effective-tool-integration, harness-engineering/multimodal-ai-orchestration-design-patterns, agents/llm-agent-dynamic-tool-selection-optimization, agents/llm-agent-long-term-memory-tool-use-patterns]
status: draft
