...
tags:
  ...
  - context-engineering
confidence: 1
connections: [agents/external-tool-integration-for-ai-agents, agents/llm-agent-dynamic-tool-selection-optimization, agents/ai-agent-context-window-optimization-session-longevity, context-engineering/jit-embedding-retrieval-context-cost-scale-invariant, context-engineering/claude-code-harness-large-codebase-architecture-patterns, data-engineering/rag-data-preprocessing-embedding-optimization-strategies, prompt-engineering/rag-prompt-optimization-retrieval-augmented-generation, agents/ai-agent-transparent-execution-knowledge-integration, evaluation/semantic-versioning-code-drift-detection, agents/dynamic-codebase-wiki-with-ai-agents, context-engineering/llm-knowledge-propagation-connection-mechanisms]
status: draft
