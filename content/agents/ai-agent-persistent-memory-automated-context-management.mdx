...
tags:
  ...
  - agents
confidence: 1
connections: [context-engineering/hub-worker-compounding-pattern, agents/llm-agent-long-term-memory-tool-use-patterns, agents/long-term-memory-management-patterns-for-ai-agents, context-engineering/on-device-vector-db-jit-semantic-search, agents/generative-ai-agent-long-term-memory-strategies, context-engineering/ai-agent-context-management-project-memory, agents/ai-human-collaborative-workspace-architecture-buzz, agents/autonomous-agent-long-term-memory-implementation, context-engineering/ai-agent-codebase-wiki-contextual-enhancement, android-ai/agent-control-cli-integration, agents/dynamic-codebase-wiki-with-ai-agents, harness-engineering/recursive-self-improvement-harness-enhancement, context-engineering/karpathy-llm-wiki-agent-knowledge-retrieval-playbook, agents/autonomous-agent-long-term-memory-reflection-design, context-engineering/xirp-organizational-context-ai-agent-knowledge-hub]
status: draft
