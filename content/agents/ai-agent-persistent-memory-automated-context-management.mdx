...
tags:
  ...
  - agents
confidence: 1
connections: [agents/autonomous-agent-long-term-memory-management, agents/ai-agent-context-window-optimization-session-longevity, context-engineering/claude-code-session-context-persistence-ctx-plugin, context-engineering/hub-worker-compounding-pattern, context-engineering/agentic-multi-layer-state-persistence-decision-framework, agents/external-tool-integration-for-ai-agents, agents/llm-agent-long-term-memory-tool-use-patterns, agents/long-term-memory-management-patterns-for-ai-agents, context-engineering/on-device-vector-db-jit-semantic-search, agents/generative-ai-agent-long-term-memory-strategies, context-engineering/ai-agent-context-management-project-memory, agents/ai-human-collaborative-workspace-architecture-buzz, agents/autonomous-agent-long-term-memory-implementation, context-engineering/ai-agent-codebase-wiki-contextual-enhancement, android-ai/agent-control-cli-integration]
status: draft
