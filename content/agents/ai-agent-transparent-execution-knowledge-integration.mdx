...
tags:
  ...
  - agents
confidence: 1
connections: [project-ops/claude-goal-playbook-worker-automation, context-engineering/hub-pull-evidence-tracking-from-hub-convention, agents/agentic-self-documentation-dual-perspective-knowledge-accumulation, agents/agentic-long-running-carryover-human-checkpoint-boundary, agents/llm-agent-goal-achievement-planning-patterns, agents/ai-agent-code-knowledge-graph-integration-efficiency, agents/llm-agent-persistent-goal-management-long-term-tasks, agents/ai-agent-output-versioning-deltadb-concepts, agents/agent-codebase-exploration-visualization-tool, project-ops/ai-automation-human-system-understanding-sre, evaluation/agent-execution-logging-recovery-system, agents/evidence-graph-ai-agent-compliance-verification]
status: draft
