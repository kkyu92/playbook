...
tags:
  ...
  - context-engineering
confidence: 1
connections: [context-engineering/ambient-knowledge-injection, infrastructure/claude-code-ctx-plugin-context-persistence, agents/enterprise-agent-management-patterns-llm-orchestration, agents/code-based-agent-task-patterns-harness-design, agents/multi-agent-task-collaboration-coordination-strategies]
status: draft
