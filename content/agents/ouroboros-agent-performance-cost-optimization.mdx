...
tags:
  ...
  - agents
confidence: 1
connections: [agents/gpt-5-5-agent-model-evaluation-integration-strategies, infrastructure/claude-code-cost-optimization-strategies, data-engineering/vector-db-embedding-data-optimization-patterns, prompt-engineering/on-device-llm-inference-efficiency-patterns, project-ops/claude-goal-playbook-worker-automation, infrastructure/claude-code-harness-cost-optimization-reassessment, prompt-engineering/llm-token-waste-detection-cli]
status: draft
