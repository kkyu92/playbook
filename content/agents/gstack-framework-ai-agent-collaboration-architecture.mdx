...
tags:
  ...
  - harness-engineering
confidence: 1
connections: [agents/qwen3-6-max-preview-llm-agentic-coding-evaluation, prompt-engineering/llm-prompt-optimization-role-definition-constraint-design, agents/google-agents-cli-agent-development-acceleration, project-ops/ai-project-planning-roadmap-initial-strategy, agents/gpt-5-5-agent-model-evaluation-integration-strategies, context-engineering/claude-code-session-web-mobile-monitoring-implementation, context-engineering/ephemeral-credentials-session-llm-harness, agents/vercel-ai-sdk-adapter-local-external-coding-agents, agents/multi-agent-collaboration-complex-problem-solving, agents/multi-agent-collaboration-design-patterns, android-ai/jetpack-compose-ai-streaming-agentic-ux-patterns, journal/playbook-journal-017-agent-loop-cron-develop-cycle-skill-manual-trigger, journal/playbook-journal-019-develop-cycle-tier-2-n-3-2-candidate-5]
status: draft
