...
tags:
  ...
  - agents
confidence: 1
connections: [agents/llm-agent-autonomy-complex-problem-solving, agents/multimodal-ai-agent-tool-usage-design, agents/advanced-ai-agent-tool-use-patterns, evaluation/llm-judgment-code-verification-separation-architecture, harness-engineering/llm-tooling-harness-complex-api-integration, agents/llm-agent-tool-integration-patterns, harness-engineering/recursive-self-improvement-harness-enhancement, agents/agent-plugin-architecture-design-modularity, harness-engineering/glm-5-3-code-generation-agent-harness-enhancement, agents/prime-agent-rlm-continual-harness-playbook-advancement, agents/autonomous-agent-llm-workflow-design-patterns, agents/llm-agent-external-tool-plugin-integration, agents/llm-agent-tool-utilization-optimization, agents/agent-native-framework-unified-action-layer, android-ai/on-device-nl-to-action-needle3-android-poc]
status: draft
