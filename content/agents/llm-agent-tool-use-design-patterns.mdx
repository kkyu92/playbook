...
tags:
  ...
  - agents
confidence: 1
connections: [context-engineering/zerostack-rust-agent-harness-extension, agents/autonomous-agent-long-term-memory-management, agents/multimodal-ai-agent-effective-tool-integration, agents/mirage-ai-agent-unified-filesystem-integration, agents/llm-agent-tool-call-reliability-forge-guardrails, agents/antigravity-managed-agents-api-integration-review, agents/qwen3-7-max-agent-model-evaluation-integration, agents/inference-chain-design-complex-ai-agents, agents/llm-agent-dynamic-tool-selection-optimization, agents/llm-agent-long-term-memory-tool-use-patterns, agents/llm-agent-autonomy-complex-problem-solving, agents/multimodal-ai-agent-tool-usage-design, agents/advanced-ai-agent-tool-use-patterns, evaluation/llm-judgment-code-verification-separation-architecture, data-engineering/fenic-semantic-dataframes-llm-integration]
status: draft
