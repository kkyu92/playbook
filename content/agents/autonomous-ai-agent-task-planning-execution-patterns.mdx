...
tags:
  ...
  - agents
confidence: 1
connections: [agents/autonomous-ai-agent-decision-logic-implementation-patterns, agents/llm-agent-goal-achievement-planning-patterns, agents/ai-agent-self-correction-design-principles, agents/multi-agent-collaboration-design-patterns, agents/llm-agent-autonomy-complex-problem-solving, agents/llm-autonomous-agent-self-reflection-tool-use-patterns, agents/autonomous-agent-multi-stage-decision-making-patterns, agents/autonomous-agent-dynamic-planning-goal-strategies, harness-engineering/agent-loop-patterns-autonomous-task-completion, agents/multi-agent-task-decomposition-role-assignment, android-ai/needle-2-on-device-agentic-llm-android-application, agents/llm-agent-complex-task-planning-orchestration, prompt-engineering/pseudocode-driven-ai-coding-control-experiment, agents/generative-ai-agent-autonomous-problem-solving-patterns, agents/autonomous-agent-behavioral-planning-reasoning-system-design]
status: draft
