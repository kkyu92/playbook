...
tags:
  ...
  - agents
confidence: 1
connections: [agents/ai-agent-persistent-memory-automated-context-management, agents/autonomous-agent-long-term-memory-management, agents/llm-agent-long-term-memory-tool-use-patterns, context-engineering/agentic-oos-memory-drift-count-smoke-baseline, data-engineering/vector-db-embedding-data-optimization-patterns, data-engineering/rag-data-preprocessing-embedding-optimization-strategies, harness-engineering/llm-agent-persistent-goal-management-long-term-tasks, context-engineering/ai-agent-long-term-memory-system-integration, context-engineering/claude-code-agent-persistent-memory-ctx-integration, agents/llm-agent-memory-diagnostic-architecture-brain-ai, agents/generative-ai-agent-long-term-memory-strategies, agents/autonomous-agent-long-term-memory-implementation, agents/agent-rationale-storage-decision-learning-system, agents/llm-multi-agent-system-design-orchestration-patterns, agents/dynamic-codebase-wiki-with-ai-agents]
status: draft
