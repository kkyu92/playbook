...
tags:
  ...
  - agents
confidence: 1
connections: [agents/autonomous-agent-long-term-memory-management, infrastructure/guard-test-pattern, context-engineering/silent-drift-family-pattern, agents/ai-agent-superpowers-guardrails-intent-alignment, agents/llm-agent-memory-diagnostic-architecture-brain-ai]
status: draft
