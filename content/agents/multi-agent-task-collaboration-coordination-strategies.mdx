...
tags:
  ...
  - agents
confidence: 1
connections: [agents/multi-tool-ai-agent-design-patterns-orchestration, agents/ruflo-multi-agent-orchestration-claude-code-playbooks, agents/superagent-harness-architecture-long-running-task-orchestrat, agents/multi-agent-decision-making-patterns, agents/multi-agent-system-efficient-interaction-design-patterns, agents/multi-stage-agent-task-scheduling-monitoring, agents/multi-agent-collaboration-system-design-patterns, agents/paca-ai-agent-project-management-tool-review, agents/multi-agent-collaboration-complex-task-patterns, agents/multi-agent-collaboration-decision-logic-design-patterns, agents/multi-agent-collaboration-protocol-design-principles]
status: draft
