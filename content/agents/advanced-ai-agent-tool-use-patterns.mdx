...
tags:
  ...
  - agents
confidence: 1
connections: [agents/external-tool-integration-for-ai-agents, agents/llm-agent-dynamic-tool-selection-optimization, agents/llm-agent-tool-use-design-patterns, agents/multi-tool-ai-agent-design-patterns-orchestration, agents/multimodal-ai-agent-tool-usage-design, agents/llm-agent-tool-call-reliability-forge-guardrails, agents/autonomous-ai-agent-decision-logic-implementation-patterns, agents/muse-spark-multimodal-agent-harness-integration, agents/llm-autonomous-agents-strategic-tool-orchestration, android-ai/needle-2-on-device-agentic-llm-android-application, harness-engineering/multi-llm-external-tool-harness-architecture-design, agents/autonomous-agent-reliable-tool-use-patterns, harness-engineering/corsair-ai-agent-service-connection-permission, agents/agent-native-framework-unified-action-layer, harness-engineering/agent-harness-async-tool-user-intervention-patterns]
status: draft
