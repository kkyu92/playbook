...
tags:
  ...
  - agents
confidence: 1
connections: [agents/autonomous-agent-long-term-memory-management, agents/llm-agent-long-term-memory-tool-use-patterns, agents/ai-agent-context-window-optimization-session-longevity, data-engineering/rag-data-preprocessing-embedding-optimization-strategies, agents/llm-agent-persistent-goal-management-long-term-tasks, prompt-engineering/rag-prompt-optimization-retrieval-augmented-generation]
status: draft
