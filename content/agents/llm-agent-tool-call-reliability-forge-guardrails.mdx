...
tags:
  ...
  - harness-engineering
confidence: 1
connections: [infrastructure/guard-test-pattern, agents/llm-agent-tool-use-design-patterns, evaluation/llm-output-validation-quality-metrics-design, agents/concurrent-fault-tolerant-ai-workflow-design-patterns, prompt-engineering/llm-workflow-orchestration-business-logic-patterns, agents/llm-agent-dynamic-tool-selection-optimization, agents/llm-agent-long-term-memory-tool-use-patterns, agents/multimodal-ai-agent-tool-usage-design, agents/advanced-ai-agent-tool-use-patterns, agents/ai-agent-runaway-cost-prevention-control-systems, evaluation/llm-agent-observability-spanlens-trace-monitoring, harness-engineering/agent-duplicate-execution-detection-prevention, android-ai/needle-2-on-device-agentic-llm-android-application, agents/autonomous-agent-reliable-tool-use-patterns]
status: draft
