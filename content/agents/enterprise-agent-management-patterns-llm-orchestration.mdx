...
tags:
  ...
  - harness-engineering
confidence: 1
connections: [infrastructure/claude-code-ctx-plugin-context-persistence, agents/ai-agent-global-context-gc-tree-integration, evaluation/llm-input-output-data-pipeline-design-patterns, agents/ruflo-multi-agent-orchestration-claude-code-playbooks, agents/multi-agent-collaboration-complex-problem-solving, agents/superagent-harness-architecture-long-running-task-orchestrat, agents/concurrent-fault-tolerant-ai-workflow-design-patterns, agents/ai-agent-safety-constraint-control-design-patterns, agents/multimodal-ai-agent-effective-tool-integration, agents/multi-agent-decision-making-patterns, agents/antigravity-managed-agents-api-integration-review, infrastructure/claude-code-harness-multi-llm-strategy-dependency-mitigation, prompt-engineering/dynamic-prompt-routing-multi-llm-cost-performance, agents/paca-ai-agent-project-management-tool-review, context-engineering/claude-code-session-context-persistence-ctx-plugin]
status: draft
