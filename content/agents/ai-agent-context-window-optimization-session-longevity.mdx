...
tags:
  ...
  - context-engineering
confidence: 1
connections: [agents/ai-agent-code-knowledge-graph-integration-efficiency, context-engineering/claude-5-fable-llm-worker-harness-compounding-automation, agents/long-term-memory-management-patterns-for-ai-agents, agents/agentic-context-compaction-trigger-heuristics, harness-engineering/kimi-k3-1m-context-model-playbook-harness-integration, context-engineering/claude-5-context-engineering-prompt-optimization, prompt-engineering/llm-token-waste-detection-cli, context-engineering/kimi-k3-context-engineering-knowledge-processing, harness-engineering/gpt-5-6-ultrafast-mode-agent-output-optimization, prompt-engineering/claude-code-session-context-optimization, project-ops/claude-code-session-cost-optimization-strategies, harness-engineering/ai-agent-local-memory-module-session-context, harness-engineering/claude-code-harness-token-efficiency-optimization, harness-engineering/agent-harness-context-management-optimization, harness-engineering/agent-harness-async-tool-user-intervention-patterns]
status: draft
