...
tags:
  ...
  - agents
confidence: 1
connections: [agents/external-tool-integration-for-ai-agents, agents/llm-agent-tool-use-design-patterns, agents/multi-tool-ai-agent-design-patterns-orchestration, harness-engineering/llm-agent-tool-call-reliability-forge-guardrails, harness-engineering/llm-workflow-orchestration-business-logic-patterns, agents/inference-chain-design-complex-ai-agents, prompt-engineering/lao-workflow-llm-agent-design-enhancement, agents/multimodal-ai-agent-realtime-decision-logic, context-engineering/ai-agent-code-knowledge-graph-integration-efficiency, agents/llm-agent-autonomy-complex-problem-solving, agents/autonomous-ai-agent-decision-logic-implementation-patterns, agents/multimodal-ai-agent-tool-usage-design, agents/advanced-ai-agent-tool-use-patterns, agents/llm-autonomous-agents-tool-use-planning-implementation]
status: draft
