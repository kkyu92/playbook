...
tags:
  ...
  - agents
confidence: 1
connections: [agents/llm-agent-tool-use-design-patterns, agents/ai-agent-context-window-optimization-session-longevity, context-engineering/claude-code-ctx-plugin-context-persistence, context-engineering/claude-code-session-web-mobile-monitoring-implementation, frontend-ai/ai-powered-ux-frontend-design-patterns, harness-engineering/agentic-chain-saturation-detection, agents/llm-agent-goal-achievement-planning-patterns, context-engineering/claude-code-agent-view-worker-management-integration, context-engineering/flue-framework-integration-claude-code-harness-reconfigurati, infrastructure/claude-cli-persistent-multi-session-web-terminal]
status: draft
