...
tags:
  ...
  - agents
confidence: 1
connections: [agents/external-tool-integration-for-ai-agents, agents/ai-agent-robust-tool-error-recovery, agents/llm-agent-dynamic-tool-selection-optimization, agents/ai-agent-control-validation-mechanisms, agents/multi-tool-ai-agent-design-patterns-orchestration, agents/advanced-ai-agent-tool-use-patterns, android-ai/agent-control-cli-integration, infrastructure/ai-agent-tool-access-gateway-design, harness-engineering/oh-my-portal-browser-ai-agent-remote-control, harness-engineering/multi-llm-external-tool-orchestration-patterns, harness-engineering/corsair-ai-agent-service-connection-permission, harness-engineering/claude-commerce-agent-blueprint-harness-extension, agents/ai-agent-web-search-data-collection-re-ranking, harness-engineering/multi-llm-external-api-integration-harness-patterns, agents/agent-native-framework-unified-action-layer]
status: draft
