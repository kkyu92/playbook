...
tags:
  ...
  - harness-engineering
confidence: 1
connections: [project-ops/claude-code-harness-skillset-reinforcement-agent-playbook, context-engineering/agentic-cycle-state-json-carry-over-design, project-ops/production-db-ai-agent-guardrails, agents/ai-agent-superpowers-guardrails-intent-alignment, context-engineering/zerostack-rust-agent-harness-extension, agents/ai-collaboration-5-principles-playbook-agent-workflow-optimi, agents/inference-chain-design-complex-ai-agents, prompt-engineering/dynamic-prompt-routing-multi-llm-cost-performance, agents/autonomous-ai-agent-decision-logic-implementation-patterns, prompt-engineering/dynamic-prompt-management-large-scale-llm-workflows, agents/multi-hop-reasoning-agent-design-patterns, prompt-engineering/pseudocode-driven-ai-coding-control-experiment]
status: draft
