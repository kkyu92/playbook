---
title: "Playbook Journal 064 — WAR data gap post-break compound effect — Fancy Stats top-50 + normalization bug"
...
status: in-progress
description: "자동 수집: WAR data gap post-break compound effect — Fancy Stats top-50 + normalization bug (from kkyu92/moneyballscore)"
type: entry
series: playbook-journal
raw_source: "raw-sources/_archive/20260720-war-data-gap-post-break-compound-effect-fancy-stat-afb5db79c6ab01049d69c9dde241be.md"
---
