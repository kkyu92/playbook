...
tags:
  ...
  - moneyball
confidence: 3
connections: [evaluation/generative-ai-model-evaluation-quantitative-qualitative-meth, project-ops/question-own-defaults, journal/playbook-journal-030-3-cleanup-confidence-h2h]
status: in-progress
