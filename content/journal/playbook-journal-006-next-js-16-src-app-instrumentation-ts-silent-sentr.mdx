...
connections: [context-engineering/nextjs-instrumentation-location, harness-engineering/hub-worker-compounding-pattern, journal/playbook-journal-007-sentry-sensitive-fields-beforesend]
status: in-progress
