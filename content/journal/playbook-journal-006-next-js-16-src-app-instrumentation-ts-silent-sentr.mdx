...
connections: [context-engineering/nextjs-instrumentation-location, harness-engineering/hub-worker-compounding-pattern, journal/playbook-journal-007-sentry-sensitive-fields-beforesend, frontend-ai/claude-code-session-web-mobile-monitoring-implementation]
status: in-progress
