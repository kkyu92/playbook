...
connections: [infrastructure/sentry-pii-scrubbing-beforesend, infrastructure/sentry-serverless-flush, harness-engineering/hub-worker-compounding-pattern, journal/playbook-journal-006-next-js-16-src-app-instrumentation-ts-silent-sentr, harness-engineering/vercel-breach-third-party-ai-oauth-supply-chain-security, infrastructure/vercel-env-oauth-security-enhancement, infrastructure/npm-pnpm-supply-chain-security-enhancement]
status: in-progress
