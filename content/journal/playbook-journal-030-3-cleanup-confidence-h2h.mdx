...
tags:
  ...
  - moneyball
confidence: 3
connections: [evaluation/prediction-model-calibration-inversion-detection, journal/playbook-journal-027-cycle-59-sfr-h2h-prod-30-bias-bootstrap-ci-systema, journal/playbook-journal-031-w20-20-calibration-cycle-308]
status: complete
