...
tags:
  ...
  - infrastructure
confidence: 1
connections: [infrastructure/nextjs-instrumentation-location, project-ops/production-db-ai-agent-guardrails, evaluation/llm-response-quality-automated-evaluation-metrics-design-str, project-ops/claude-code-harness-skillset-reinforcement-agent-playbook, frontend-ai/generative-ai-ui-ux-design-patterns, evaluation/rag-application-evaluation-retrieval-generation-quality, infrastructure/claude-api-key-security-audit-usage-pattern-validation, infrastructure/claude-interaction-security-guidelines-endpoint-protection]
status: draft
