...
tags:
  ...
  - infrastructure
confidence: 1
connections: [context-engineering/nextjs-instrumentation-location, data-engineering/production-db-ai-agent-guardrails, evaluation/llm-output-validation-quality-metrics-design, evaluation/llm-response-quality-automated-evaluation-metrics-design-str, harness-engineering/claude-code-harness-skillset-reinforcement-agent-playbook, frontend-ai/generative-ai-ui-ux-design-patterns, evaluation/rag-application-evaluation-retrieval-generation-quality, infrastructure/claude-api-key-security-audit-usage-pattern-validation, infrastructure/claude-interaction-security-guidelines-endpoint-protection]
status: draft
