...
tags:
  ...
  - harness-engineering
confidence: 1
connections: [context-engineering/ai-agent-remote-management-ux-persistent-web-terminals, context-engineering/claude-code-session-context-persistence-ctx-plugin, agents/llm-agent-persistent-goal-management-long-term-tasks, journal/playbook-journal-009-claude-cli-hang-paperclip-4-step, infrastructure/zero-touch-develop-cycle-session-management, context-engineering/claude-code-session-web-mobile-monitoring-implementation, context-engineering/agentic-coding-claude-harness-playbook-strategy, harness-engineering/oh-my-portal-browser-ai-agent-remote-control]
status: draft
