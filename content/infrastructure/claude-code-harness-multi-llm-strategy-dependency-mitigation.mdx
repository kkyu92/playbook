...
tags:
  ...
  - infrastructure
confidence: 1
connections: [context-engineering/claude-code-harness-large-codebase-architecture-patterns, evaluation/llm-api-dependency-risk-mitigation-strategy, prompt-engineering/multi-llm-routing-design-patterns-cost-performance, agents/enterprise-agent-management-patterns-llm-orchestration, infrastructure/gomodel-llm-gateway-introduction-strategy, agents/multi-llm-agent-workload-partitioning-patterns, prompt-engineering/llm-scalable-service-architecture-patterns, project-ops/claude-code-harness-cost-optimization-reassessment, agents/glm-5-2-agent-extension-validation-enhancement]
status: draft
