...
tags:
  ...
  - infrastructure
confidence: 1
connections: [infrastructure/npm-pnpm-supply-chain-security-enhancement, infrastructure/vercel-breach-third-party-ai-oauth-supply-chain-security, infrastructure/github-token-anti-recursion-ghat-pat-workflow-trigger, infrastructure/claude-api-key-security-audit-usage-pattern-validation, evaluation/llm-api-dependency-risk-mitigation-strategy, journal/playbook-journal-037-pnpm-lock-yaml-ci-frozen-lockfile, infrastructure/claude-interaction-security-guidelines-endpoint-protection]
status: draft
