...
tags:
  ...
  - infrastructure
confidence: 1
connections: [infrastructure/vercel-breach-third-party-ai-oauth-supply-chain-security, infrastructure/vercel-env-oauth-security-enhancement, infrastructure/sentry-pii-scrubbing-beforesend, journal/playbook-journal-002-drift-existing-setup, journal/playbook-journal-007-sentry-sensitive-fields-beforesend, project-ops/question-own-defaults, project-ops/open-source-supply-chain-security-llm-tools-hardening]
status: draft
