...
tags:
  ...
  - harness-engineering
confidence: 1
connections: [infrastructure/sentry-pii-scrubbing-beforesend, journal/playbook-journal-007-sentry-sensitive-fields-beforesend, project-ops/question-own-defaults, infrastructure/vercel-env-oauth-security-enhancement, infrastructure/npm-pnpm-supply-chain-security-enhancement, context-engineering/ephemeral-credentials-session-llm-harness, infrastructure/claude-code-commit-message-hermes-md-monitoring-remediation, agents/vercel-ai-sdk-adapter-local-external-coding-agents, infrastructure/claude-api-key-security-audit-usage-pattern-validation, infrastructure/claude-interaction-security-guidelines-endpoint-protection, infrastructure/open-source-supply-chain-security-llm-tools-hardening]
status: draft
