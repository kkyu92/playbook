...
tags:
  ...
  - infrastructure
confidence: 1
connections: [infrastructure/vercel-breach-third-party-ai-oauth-supply-chain-security, evaluation/llm-api-dependency-risk-mitigation-strategy, context-engineering/ephemeral-credentials-session-llm-harness, harness-engineering/silent-drift-family-pattern, project-ops/production-db-ai-agent-guardrails, infrastructure/nextjs-security-patching-defense-logic-reinforcement, project-ops/claude-code-cost-optimization-strategies, infrastructure/claude-interaction-security-guidelines-endpoint-protection, infrastructure/open-source-supply-chain-security-llm-tools-hardening]
status: draft
