...
tags:
  ...
  - harness-engineering
confidence: 1
connections: [harness-engineering/drift-detection-methodology, infrastructure/guard-test-pattern, harness-engineering/hub-worker-compounding-pattern, agents/ai-agent-superpowers-guardrails-intent-alignment, evaluation/react-doctor-ai-code-validation-pipeline]
status: draft
