...
tags:
  ...
  - harness-engineering
confidence: 1
connections: [context-engineering/drift-detection-methodology, infrastructure/guard-test-pattern, context-engineering/hub-worker-compounding-pattern, agents/ai-agent-superpowers-guardrails-intent-alignment, evaluation/react-doctor-ai-code-validation-pipeline]
status: draft
