...
tags:
  ...
  - harness-engineering
confidence: 1
connections: [agents/ai-agent-superpowers-guardrails-intent-alignment, project-ops/react-doctor-ai-code-validation-pipeline, android-ai/jetpack-compose-ai-streaming-agentic-ux-patterns, android-ai/mediapipe, evaluation/llm-prompt-validator-symmetry-drift, reports/closed-loop-health]
status: draft
