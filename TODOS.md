...
**상태**: local main: **38커밋 ahead** (cycles 336-360 + auto-ingest), origin main: **32커밋 ahead** (moneyball auto-ingest + daily-ingest)
**검출**: 2026-05-12 cycle 360 진단 (`git rev-list --left-right --count origin/main...main` = `32	38`)
